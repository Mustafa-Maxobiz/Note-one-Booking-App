    ...
    <div class="col-lg-8">
        <div class="modern-card">
            <div class="modern-card-header">
                ...
                <p class="modern-card-subtitle">Update the user's details and preferences</p>
            </div>
            <div class="modern-card-body">
                <form method="POST" action="{{ route('admin.users.update', $user) }}">
                    ...
                    @if($user->role === 'teacher' && $user->teacher)
                        <hr class="my-4">
                        <h5 class="text-primary mb-3"><i class="fas fa-chalkboard-teacher me-2"></i>Teacher Profile</h5>
                        
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="bio" class="form-label">Bio</label>
                                <textarea class="form-control @error('bio') is-invalid @enderror" 
                                          id="bio" name="bio" rows="3">{{ old('bio', $user->teacher->bio) }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('qualifications') is-invalid @enderror" 
                                       id="qualifications" name="qualifications" value="{{ old('qualifications', $user->teacher->qualifications) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_verified" name="is_verified" value="1" 
                                           {{ old('is_verified', $user->teacher->is_verified) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_verified">
                                        <i class="fas fa-check-circle text-success me-1"></i>Verified Teacher
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_available" name="is_available" value="1" 
                                           {{ old('is_available', $user->teacher->is_available) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_available">
                                        <i class="fas fa-clock text-primary me-1"></i>Available for Bookings
                                    </label>
                                </div>
                            </div>
                        </div>
