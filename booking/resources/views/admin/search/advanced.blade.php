        ...
        <div class="col-12">
            ...
            <div class="page-header mb-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="page-title">
                            <i class="fas fa-search me-3"></i>Advanced Search Results
                        </h1>
                        <p class="page-subtitle">Applied filters: {{ count(array_filter($filters)) }} criteria</p>
                    </div>
            ...
            <div class="modern-card">
                <div class="modern-card-body">
                    <div class="row mb-3">
                        <div class="col-12">
                            <h5>Advanced Search Results</h5>
                            <p class="text-muted">Applied filters: {{ count(array_filter($filters)) }} criteria</p>
                        </div>
                    </div>
                    ...
                    @if(empty($results) || (isset($results['users']) && $results['users']->count() === 0 && 
                        ...
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">Try adjusting your search criteria or use different filters.</p>
