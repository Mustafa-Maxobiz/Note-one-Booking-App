...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <p class="page-subtitle">View recordings for this session</p>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('student.session-recordings.show', $recording) }}" class="btn btn-outline-primary" title="View Details">
