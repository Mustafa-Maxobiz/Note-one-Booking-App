    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 text-end">
            <div class="header-actions">
                <a href="{{ route('student.session-recordings.index') }}" class="btn btn-outline-light me-2">
    ...
    <div class="col-lg-8">
            ...
            <div class="modern-card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Teacher:</strong> {{ $recording->booking->teacher->user->name }}</p>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="modern-card mb-4">
            <div class="modern-card-header">
                ...
                <p class="modern-card-subtitle">Watch or listen to your session recording</p>
            </div>
            <div class="modern-card-body">
        ...
        <div class="modern-card mb-4">
            ...
            <div class="modern-card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('student.session-recordings.index') }}" class="btn btn-outline-secondary">
