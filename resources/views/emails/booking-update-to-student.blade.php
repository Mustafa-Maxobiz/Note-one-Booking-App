...
<body>
    <div class="header">
        ...
        <p>Important changes have been made to your session</p>
    </div>

    <div class="content">
        <h2>Hello {{ $student_name }},</h2>
        
        <p>We're writing to inform you that your session with <strong>{{ $teacher_name }}</strong> has been updated. Please review the changes below:</p>
        ...
        <div class="teacher-info">
            ...
            <p><strong>Subject:</strong> {{ $booking->teacher->qualifications ?? 'Not specified' }}</p>
        </div>
        ...
        <div class="highlight">
            ...
            <ul>
                ...
                <li>If you have any questions about the changes, contact your teacher directly</li>
                <li>Make sure you're available for the new scheduled time</li>
                <li>If the new time doesn't work for you, please contact support immediately</li>
            </ul>
        </div>
        ...
        <div class="info-box">
            ...
            <ul>
                ...
                <li>Prepare any materials you need for the lesson</li>
                <li>Contact your teacher if you have any questions</li>
            </ul>
        </div>

        <p>We apologize for any inconvenience this change may cause. If you have any concerns about the new schedule, please don't hesitate to contact us.</p>
