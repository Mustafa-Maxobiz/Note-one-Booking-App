...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <p class="page-subtitle">Access and browse your recorded teaching sessions</p>
        </div>
...
<div class="modern-card">
    <div class="modern-card-header">
        ...
        <p class="modern-card-subtitle">Browse your recorded teaching sessions</p>
    </div>
    <div class="modern-card-body">
                            ...
                            <tr class="recording-row">
                                ...
                                <td>
                                    <div class="student-info">
                                        <div class="student-name">{{ $recording->booking->student->user->name ?? 'N/A' }}</div>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('teacher.session-recordings.show', $recording) }}" class="btn btn-sm btn-outline-info action-btn" title="View Details">
        ...
        @else
            <div class="text-center py-5">
                ...
                <a href="{{ route('teacher.bookings.index') }}" class="btn btn-primary">
